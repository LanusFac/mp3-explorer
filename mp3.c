...
{
	char temp_name_str[LEXEM_SPAN_TITLE + 1];
	char temp_artist_str[LEXEM_SPAN_ARTIST + 1];
	char temp_album_str[LEXEM_SPAN_ALBUM + 1];
	char temp_year_str[LEXEM_SPAN_YEAR + 1];
	char temp_comment_str[LEXEM_SPAN_COMMENT + 1];
	char temp_genre_str[LEXEM_SPAN_GENRE + 1];
	char * temp_str;
